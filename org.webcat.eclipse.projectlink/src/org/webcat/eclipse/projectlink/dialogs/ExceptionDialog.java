...
public class ExceptionDialog extends Dialog
{
	 ...
	 */
	public ExceptionDialog(Shell shell, Throwable exception)
	{
		this(shell, exception, false);
	}
	...
	protected Control createDialogArea(Composite parent)
	{
		...
		headerComp.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
		gl = new GridLayout();
		gl.numColumns = 2;
		...
		getShell().setText(Messages.ExceptionDialog_Title);
	...
	private void setFromParseErrors(TargetParseError[] errors)
	{
		...
		summaryString = Messages.ExceptionDialog_Parse_Errors;
	}
	...
	private void setFromException(Throwable e)
	{
		...
		summaryString = Messages.ExceptionDialog_General_Error;
	}
}
