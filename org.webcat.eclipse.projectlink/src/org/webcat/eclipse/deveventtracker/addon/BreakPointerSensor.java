...
public class BreakPointerSensor implements IBreakpointListener {
  ...
  public void breakpointAdded(IBreakpoint breakpoint) {
    ...
    try {
      ...
      this.eclipseSensor.addDevEvent("Debug", projectURI, fileResource, debugData, message);
    }
  ...
  public void breakpointRemoved(IBreakpoint breakpoint, IMarkerDelta delta) {
    ...
    try {
      ...
      this.eclipseSensor.addDevEvent("Debug", projectURI, fileResource, keyValueMap, message);
    }
    catch (CoreException e) {
